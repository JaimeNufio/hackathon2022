<template>
  <div class="container p-2 mt-5" style="min-height:80vh">
    <div class="about pt-3" style="background-color:rgba(25,25,25,.4); border-radius: 25px;">
        <div class="mb-2 mt-1" style="font-size:2em">About Us</div>
